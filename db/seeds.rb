...
taMon8 = TimeAvailability.create(:day => "Monday", :start_time => 8) # Monday 08:00 - 8am
...
tutor1.time_availabilitys << taMon8 << taMon9
tutor1.save! 

tutor2 = Tutor.new
tutor2.email = "tutor2@gmail.com"
tutor2.first_name = "tutor2_firstname"
tutor2.last_name = "tutor2_lastname"
tutor2.sid = "22222222"
tutor2.year = "senior"
tutor2.phone_number = "222-222-2222"
tutor2.major = "CS"
tutor2.tutor_cohort = "2"
tutor2.bio = "I am tutor 2"
tutor2.password = "tutor2"
tutor2.password_confirmation = "tutor2"
tutor2.time_availabilitys << taMon15 << taMon16
tutor2.save!

tutor3 = Tutor.new
tutor3.email = "tutor3@gmail.com"
tutor3.first_name = "tutor3_firstname"
tutor3.last_name = "tutor3_lastname"
tutor3.sid = "33333333"
tutor3.year = "senior"
tutor3.phone_number = "333-333-3333"
tutor3.major = "CS"
tutor3.tutor_cohort = "3"
tutor3.bio = "I am tutor 3"
tutor3.password = "tutor3"
tutor3.password_confirmation = "tutor3"
tutor3.time_availabilitys << taMon8 << taWed13 << taWed14
tutor3.save! 

tutor4 = Tutor.new
tutor4.email = "tutor4@gmail.com"
tutor4.first_name = "tutor4_firstname"
tutor4.last_name = "tutor4_lastname"
tutor4.sid = "44444444"
tutor4.year = "senior"
tutor4.phone_number = "444-444-4444"
tutor4.major = "CS"
tutor4.tutor_cohort = "4"
tutor4.bio = "I am tutor 4"
...
#Available to be matched with Tutors 1, 2 and 3
#Should be matched to Tutor 1 if done in this order for tests
tutee1 = Tutee.new
...
tutee1.time_availabilitys << taMon8 << taMon15
tutee1.save!

#Available to be matched with Tutors 1 and 3
#Should be matched to Tutor 3 if done in this order for tests
tutee2 = Tutee.new
...
tutee2.sid = "02"
tutee2.grade = "Freshman"
tutee2.phone_number = "022-222-2222"
tutee2.semesters_at_cal = "2"
tutee2.major = "CS"
tutee2.requested_class = "CS169"
tutee2.time_availabilitys << taMon8
tutee2.save!
...
tutee3.sid = "033333333"
tutee3.grade = "Junior"
tutee3.phone_number = "033-333-333"
tutee3.semesters_at_cal = "3"
tutee3.major = "CS"
tutee3.requested_class = "CS169"
tutee3.time_availabilitys << taMon8
tutee3.save!

#Available to be matched with Tutors 1, 2, 3 and 4
#Should be matched to Tutor 2 if done in this order for tests
tutee4 = Tutee.new
...
tutee4.sid = "044444444"
tutee4.grade = "Freshman"
tutee4.phone_number = "044-444-4444"
tutee4.semesters_at_cal = "4"
tutee4.major = "CS"
tutee4.requested_class = "CS169"
